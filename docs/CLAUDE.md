...
**Fase ativa: Fase 3 — AI Agent + RAG.** Próxima PR é **F3.2 (ingestion pipeline)**.

Roadmap completo da Fase 3 (9 PRs sequenciais) em [`AI_AGENT_RAG_ROADMAP.md`](./AI_AGENT_RAG_ROADMAP.md).
...
2. Confirmar a fase ativa lendo a seção 3 deste arquivo + checklist da seção 12 do [`AI_AGENT_RAG_ROADMAP.md`](./AI_AGENT_RAG_ROADMAP.md)
...
- [`AI_AGENT_RAG_ROADMAP.md`](./AI_AGENT_RAG_ROADMAP.md) — **fase ativa.** Roadmap completo do AI Agent + RAG em 9 PRs (F3.1..F3.8), com arquitetura, migrations, contratos, riscos e checklist
...
**Roadmap fonte:** [`AI_AGENT_RAG_ROADMAP.md`](./AI_AGENT_RAG_ROADMAP.md), seções 6 (fases) e 11 (sequência de PRs).
